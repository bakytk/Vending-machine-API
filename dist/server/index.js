...
console.log("redisClient", redisClient_1.redisClient);
console.log("redisClient.keys: ", Object.keys(redisClient_1.redisClient));
console.log("redisClient.key.value: ", redisClient_1.redisClient.get("myKey"));
